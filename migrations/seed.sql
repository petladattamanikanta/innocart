-- =============================================================================
-- INNOCART V2 — Seed Data Script
-- File    : migrations/seed.sql
-- Purpose : Populate DB with 21 product catalogue SKUs, EPC tags, 5-stage
--           AI scoring rules, rush deals, and admin user.
-- =============================================================================
...
DELETE FROM facial_color_harmony;
