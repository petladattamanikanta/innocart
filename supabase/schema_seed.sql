-- =========================================================================
-- INNOCART COMPLETE SUPABASE POSTGRESQL SCHEMA & 30-PRODUCT MASTER SEED SCRIPT
-- Copy and paste this entire script into your Supabase Dashboard -> SQL Editor
-- =========================================================================

-- 1. Create product_master table & add all missing columns
...
-- Drop any legacy strict foreign keys or check constraints blocking inserts
...
-- 5. Create users table for mobile companion app
CREATE TABLE IF NOT EXISTS users (
    user_id            VARCHAR(50) PRIMARY KEY,
    name               VARCHAR(150) NOT NULL,
    email              VARCHAR(255) UNIQUE NOT NULL,
    password_hash      VARCHAR(255) NOT NULL,
    facial_hex         VARCHAR(10) DEFAULT '#D4A373',
    undertone_label    VARCHAR(50) DEFAULT 'Warm-Golden',
...
-- 6. Insert 30 Master Products into product_master
INSERT INTO product_master (sku, name, price, image_url, garment_category, garment_type, style_profile, color_family, major_color_hex, pattern, aisle_location, is_active)
VALUES
...
-- 7. Insert RFID EPC Tags into inventory_live (Supports both E280... and E288... prefixes)
INSERT INTO inventory_live (epc_id, sku, store_id, is_active)
VALUES
('E280110C', 'SKU-KRT-01', 'STORE-001', TRUE),
('E288116C', 'SKU-KRT-01', 'STORE-001', TRUE),
('E280110D', 'SKU-TRS-02', 'STORE-001', TRUE),
('E288118D', 'SKU-TRS-02', 'STORE-001', TRUE),
('E280110E', 'SKU-SHT-03', 'STORE-001', TRUE),
('E288110E', 'SKU-SHT-03', 'STORE-001', TRUE),
('E280110F', 'SKU-SRT-04', 'STORE-001', TRUE),
('E288110F', 'SKU-SRT-04', 'STORE-001', TRUE),
('E280110G', 'SKU-JKT-05', 'STORE-001', TRUE),
('E288110G', 'SKU-JKT-05', 'STORE-001', TRUE),
('E280110H', 'SKU-SNK-06', 'STORE-001', TRUE),
('E288110H', 'SKU-SNK-06', 'STORE-001', TRUE),
('E280110I', 'SKU-HD-01', 'STORE-001', TRUE),
('E288110I', 'SKU-HD-01', 'STORE-001', TRUE),
